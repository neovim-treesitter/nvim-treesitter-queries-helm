# nvim-treesitter-queries-helm

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-helm/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-helm/actions/workflows/validate.yml)

Neovim tree-sitter queries for **helm**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-helm",
...
- [ ] Changes are scoped to `helm` — do not include files for other languages
